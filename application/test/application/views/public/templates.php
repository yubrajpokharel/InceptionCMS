...
<html manifest="greenpaper.appcache">
  <head>
	  <title><?php if(isset($title)) echo $title; else echo "Green Paper";?></title>
	  <meta charset="utf-8">
                    ...
                    <div class="mdl-cell mdl-cell--12-col">
                        <footer class="mdl-mini-footer">
                          <div class="mdl-mini-footer--left-section">
                            <div class="mdl-logo">Greenpaper.com</div>
...
<div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window"> Advertisement
    <div id="lorem">
      <?php 
...
<?php } ?>
   ...
   <script>
        $(function(){
            $('.sticky').smartSticky({destinationTop:10});
        })
    </script>
