            ...
            <div class="span9">
                <div class="well">
                    ...
                    <div class="control-group hidden">
                        ...
                        <div class="controls">
                          <input type="text" name="cat" id="cat" value="3" required="required" />
                        </div>
                    </div>
                ...
                <table id="example" class="display" cellspacing="0" width="100%" style="font-size:12px;">
                 ...
                 <?php if(isset($records)) : foreach($records as $row) : ?>
                        ...
                        <tr>
                            ...
                            <td><?=anchor("htl_package_items/delete/$row->id/dinner","Delete", $onclick);?>&nbsp;&nbsp;&nbsp;&nbsp;<?=anchor("htl_package_items/edit/$row->id","Edit", $onclick);?> </td>
                        </tr>
                    <?php endforeach; ?>
