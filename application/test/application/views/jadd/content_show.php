    ...
    <!------------------------------- List Portion of the CMS -------------------------------------------------------> 
                ...
                <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                    ...
                    <?php echo form_open_multipart('jadd/change_pro_pic',$attributes); ?>
            ...
            <div class="span9">
                ...
                <div class="well">
                    <h3>Jacket Advertisement's detail.</h3>
                <table class="table table-bordered" style="font-size:14px;">
                      ...
                      <?php $onclick = array('onclick'=>"return confirm('Are you sure you want to delete this staff member?')");?>
                        ...
                        <tr>
                            <td>Add URL</td>
                              <td><?php echo $row -> add_link; ?></td>
                        </tr>
                        
						<tr>
                            <td>Add Rate</td>
                              <td><?php echo $row -> add_rate; ?></td>
                        </tr>
                        <tr>
                            <td>Add Added for</td>
                              <td><?php echo $row -> add_added_for; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td><?=anchor("jadd/edit/$row->add_id","Edit Details");?></td>
                            <td><?=anchor("jadd/delete/$row->add_id","Delete", $onclick);?></td>
                        </tr>
                ...
                <a href="<?=base_url('index.php/jadd/')?>"><i class="icon-home"></i>Go Back</a>
