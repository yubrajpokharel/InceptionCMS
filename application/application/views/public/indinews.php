                    ...
                    <div class="mdl-cell mdl-cell--9-col mdl-cell--12-col-tablet mdl-cell--12-col-phone">
                        <div class="mdl-grid news-container">
                            ...
                            <div class="profile-page mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet shop-bg mdl-shadow--4dp mdl-cell--12-col-phone">
                                <h1 itemprop="name"><?php echo $news->news_heading;?></h1>
                                <div class="mdl-grid">
                                    <div class="profileContainer mdl-grid noborder">
                                      <div class="profilePiccard mdl-cell mdl-cell--12-col mdl-shadow--4dp">
                                              <?php 
                                                if($news->news_image != ''){ ?>    
                                                  <img itemprop="image" src="<?php echo base_url();?>uploads/news/<?php echo $news->news_image;?>" class="mdl-card__media img-responsive" title="<?php echo $news->news_heading;?>" alt="<?php echo $news->news_heading;?>">
                                              <?php  } ?>
                                                <p itemprop="description"><?php echo $news->news_description;?></p>
