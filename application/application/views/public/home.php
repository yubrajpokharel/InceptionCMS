                ...
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--12-col-phone">
                        <div class="mdl-grid news-container">
                            <!-- slider -->
                            <div class="mdl-cell--6-col mdl-cell--12-col-tablet" style="min-height:453px">
                                <div class="mdl-grid">
                                    
                                    <div class="profile-page mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet shop-bg mdl-shadow--4dp mdl-cell--12-col-phone" style="margin-top:0px">
                                        ...
                                        <div class="flexslider">
                                          <ul class="slides">
                                           <?php 
                                                ...
                                                <li>
                                                  <img alt="<?php echo $head1->news_heading;?>" title="<?php echo $head1->news_heading;?>" style="height:150px;" src="uploads/news/thumb/<?php echo $head1->news_image;?>" />
                                    ...
                                    <div class="profile-page mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet shop-bg mdl-shadow--4dp mdl-cell--12-col-phone"  style="height:50%">
                                                ...
                                                <?php 
                                                    ...
                                                    foreach ($headline as $head) { ?>
                                                      <div class="mdl-cell mdl-cell--12-col profileContainer-list mdl-grid">
                                                        ...
                                                        <div style="padding-left: 10px;padding-right: 10px;margin-bottom: -10px;"><?php echo word_limiter($head->news_description,10)?></div>
                                                    </div>
                                                  <?php } ?>
                                                ...
                                                <?php 
                                                    ...
                                                    foreach ($headline2 as $head2) { ?>
                                                      <div class="mdl-cell mdl-cell--12-col profileContainer-list mdl-grid">
                                                        ...
                                                        <div style="padding-left: 10px;padding-right: 10px;margin-bottom: -10px;"><?php echo word_limiter($head2->news_description,10)?></div>
                                                    </div>
                                                  <?php } ?>
                                              </div>
                                            </div>
                                                ...
                                                <div class="profilePiccard mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet" style="margin-top: 0px;margin-bottom: 0px;">
                                                    <div class="mdl-grid">
                                                        ...
                                                        <div class="mdl-cell mdl-cell--10-col mdl-cell--10-col-tablet" style="padding:0px; margin:0px">
                                                            <div style="font-size:12px; color: #03898A;"> - <a class="title-link2" href="<?php echo base_url('newsdetail/'.$t->id)?>"><?php echo $t->detail;?></a></div>
                                                        </div>
                                                    </div>
                                                </div>
