   <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-header">
                    ...
                    <h3 id="myModalLabel">Change PDF File </h3>
                  </div>
    ...
    <!------------------------------- List Portion of the CMS ---------------------------------------------------->        
            <div class="span9">
                ...
                <table class="table table-bordered" style="font-size:14px;">
                        <tr>
                            <th colspan="2" bgcolor="#3399FF" style="color:#FFF">PDF Table</th>
                        </tr>
            <?php if(isset($records)) : foreach($records as $row) : ?>
                        ...
                        <tr>
                            <td colspan="3" class="span3">
                                <a target="_blank" href="<?php echo base_url();?>uploads/attachments/<?php echo $row->latest_attach; ?>"><?php echo $row -> notice_name; ?></a>
                            </td>
                        </tr>
                        <tr>
