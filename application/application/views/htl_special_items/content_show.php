<!------------------------------- List Portion of the CMS -------------------------------------------------------> 
                ...
                <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                    ...
                    <?php echo form_open_multipart('Htl_special_items/change_pro_pic',$attributes); ?>
                      ...
                      <?php $onclick = array('onclick'=>"return confirm('Are you sure you want to delete this staff member?')");?>
                       ...
                       <tr>
                            <td colspan="2" class="span3">
                                <img class="span3"
                                    src="<?php echo base_url();?>uploads/specialcategoryimages/<?php echo $row->image; ?>" 
                        ...
                        <tr>
                            ...
                            <td class="span10"><?php echo $row->desc; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td><?=anchor("htl_special_items/edit/$row->id","Edit Details");?></td>
                            <td colspan="2"><?=anchor("htl_special_items/delete/$row->id","Delete", $onclick);?></td>
                        </tr>
