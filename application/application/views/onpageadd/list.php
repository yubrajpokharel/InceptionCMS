    ...
    <!------------------------------------------------ List Portion of the CMS ------------------------------------------------------------------------------>        
            <div class="span9">
            <a href="<?=base_url('pageadd/addnew')?>"><i class="icon-home"></i>Create Add</a>
            <br /><br />
                <div class="well">
                    <h3>Page Advertisement List</h3>
                <table id="example" class="display" cellspacing="0" width="100%" style="font-size:12px;">
                 ...
                 <?php if(isset($records)) : foreach($records as $row) : ?>
                        ...
                        <tr>
							...
							<td><?php echo anchor("pageadd/show/$row->add_id","$row->add_name")?></td>
                            <td>
								<?php 
