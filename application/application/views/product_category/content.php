            ...
            <div class="span9">
                <div class="well">
                    <h3>Create Product Categories</h3>
                     ...
                     echo form_open_multipart('product_category/create',$attributes); ?>
                     
                    
                    <div class="control-group">
                        <label class="control-label" for="category_name">Enter Title:</label>    
                        <div class="controls">
                          <input type="text"  class="span5" name="category_name" id="category_name" required>
                        </div>
                    </div>
                ...
                <table id="example" class="display" cellspacing="0" width="100%" style="font-size:12px;">
                 ...
                 <?php if(isset($records)) : foreach($records as $row) : ?>
                        ...
                        <tr>
                            <td><?=anchor("product_category/show/$row->cat_id","$row->cat_name")?></td>
							<td><?php echo word_limiter($row -> cat_desc, 50); ?></td>
						    <td><?=anchor("product_category/delete/$row->cat_id","Delete", $onclick);?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
