            ...
            <div class="span9 hero-unit">
                <div class="well">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                          <textarea class="span8" rows="5" type="text" maxlength="100"  name="news_heading" id="news_heading" required="required" /></textarea>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label" for="pack_type">Select Item Category:</label>    
                        <div class="controls">
